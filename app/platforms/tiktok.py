...
class TikTokResolver(Resolver):
    ...
    async def _safe_get(self, url: str, params: dict | None = None, headers: dict | None = None) -> Any:
        if CurlAsyncSession is not None:
            try:
                ...
                pass
        return await self.client.get(url, params=params, headers=headers, follow_redirects=True)
